...
public class Prof_Education extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userid = Integer.toString(AppPrefManager.getUserId(Prof_Education.this));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!school_lbl.isEmpty()) {
                    ...
                    Toast.makeText(Prof_Education.this, "Enter your details", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.f_date:
                new DatePickerDialog(Prof_Education.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                break;

            case R.id.t_date:
                new DatePickerDialog(Prof_Education.this, date1, myCalendar1.get(Calendar.YEAR), myCalendar1.get(Calendar.MONTH),
