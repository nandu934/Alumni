...
public class Prof_Introduction extends AppCompatActivity {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        AppPrefManager.setUserIntroduction(Prof_Introduction.this, intro);
                        //editText.setText(AppPrefManager.getUserIntroduction(Prof_Introduction.this));
                        Toast.makeText(Prof_Introduction.this, "successfully added", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(Prof_Introduction.this,ProfileActivity.class);
                        startActivity(i);
                        finish();
                    } else {
