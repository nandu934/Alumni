...
public class Exp_return extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = Integer.toString(AppPrefManager.getUserId(Exp_return.this));

        save_workexp= (Button) findViewById(R.id.save_workexp);
        save_workexp.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                        //editText.setText(AppPrefManager.getUserIntroduction(Prof_Introduction.this));
                        ...
                        Toast.makeText(Exp_return.this, "successfully added", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(Exp_return.this,Exp_Edu.class);
                        startActivity(i);
                        finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case android.R.id.home:
                Intent intent = new Intent(this, Exp_Edu.class);
...
//        dbHandler.close();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sdate:
                new DatePickerDialog(Exp_return.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                break;

            case R.id.edate:
                new DatePickerDialog(Exp_return.this, date1, myCalendar1.get(Calendar.YEAR), myCalendar1.get(Calendar.MONTH),
