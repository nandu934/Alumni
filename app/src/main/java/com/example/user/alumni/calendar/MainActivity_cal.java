package com.example.user.alumni.calendar;
...
import com.example.user.alumni.BuildConfig;
import com.example.user.alumni.R;
import com.example.user.alumni.activity.AppPrefManager;
import com.example.user.alumni.activity.LoginActivity;
...
public class MainActivity_cal extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
